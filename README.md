...
A high-stakes, interactive, text-based terminal slot machine game written entirely in C. Place your bets using **Tux**, watch the reels spin with real-time visual suspense, and test your luck against the random number generator to build your fortune!
...
* **Tiered Double & Triple Payout Logic:** * Landing **3 identical symbols** grants a massive full payout.
